...
tar -xzf vsearch-1.11.1.tar.gz || exit $?
...
tar -xzf vsearch5d-1.11.1.tar.gz || exit $?
...
wget -c https://ftp.ncbi.nlm.nih.gov/blast/executables/blast+/2.4.0/ncbi-blast-2.4.0+-x64-linux.tar.gz || exit $?
