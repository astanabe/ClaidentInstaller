...
wget -c http://mafft.cbrc.jp/alignment/software/mafft-7.299-linux.tgz || exit $?
tar -xzf mafft-7.299-linux.tgz || exit $?
...
rm -rf mafft-7.299-linux.tgz mafft-linux64 mafft-linux32 || exit $?
