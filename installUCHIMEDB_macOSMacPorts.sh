...
wget -c https://www.claident.org/uchimedb/20240308/cdu_20240308.tar.xz || exit $?
wget -c https://www.claident.org/uchimedb/20240308/cdu_20240308.tar.xz.sha256 || exit $?
gsha256sum -c cdu_20240308.tar.xz.sha256 || exit $?
rm -f cdu_20240308.tar.xz.sha256 || exit $?
gnutar -xJf cdu_20240308.tar.xz || exit $?
