...
wget -nv -c http://mafft.cbrc.jp/alignment/software/mafft-7.471-linux.tgz || exit $?
tar -xzf mafft-7.471-linux.tgz || exit $?
mkdir -p $PREFIX/share/claident/bin 2> /dev/null || sudo mkdir -p $PREFIX/share/claident/bin || exit $?
...
rm -rf mafft-7.471-linux.tgz mafft-linux64 mafft-linux32 || exit $?
...
mv Metaxa2_2.2/metaxa2 Metaxa2_2.2/metaxa2_* $PREFIX/share/claident/bin/ 2> /dev/null || sudo mv Metaxa2_2.2/metaxa2 Metaxa2_2.2/metaxa2_* $PREFIX/share/claident/bin/ || exit $?
...
tar -xzf ITSx_1.1.2.tar.gz || exit $?
mkdir -p $PREFIX/share/claident/bin 2> /dev/null || sudo mkdir -p $PREFIX/share/claident/bin || exit $?
rm -rf $PREFIX/share/claident/bin/ITSx_db 2> /dev/null || sudo rm -rf $PREFIX/share/claident/bin/ITSx_db || exit $?
mv ITSx_1.1.2/ITSx ITSx_1.1.2/ITSx_db $PREFIX/share/claident/bin/ 2> /dev/null || sudo mv ITSx_1.1.2/ITSx ITSx_1.1.2/ITSx_db $PREFIX/share/claident/bin/ || exit $?
rm -rf ITSx_1.1.2.tar.gz ITSx_1.1.2 || exit $?
