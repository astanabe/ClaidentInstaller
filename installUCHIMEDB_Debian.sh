...
mv dairydb1.2.4.fasta $PREFIX/share/claident/uchimedb/ || sudo mv dairydb1.2.4.fasta $PREFIX/share/claident/uchimedb/ || exit $?
...
mv silva138.1SSUref.fasta $PREFIX/share/claident/uchimedb/ || sudo mv silva138.1SSUref.fasta $PREFIX/share/claident/uchimedb/ || exit $?
...
sha256sum -c cdu_20201102.tar.xz.sha256 || exit $?
rm cdu_20201102.tar.xz.sha256 || exit $?
tar -xJf cdu_20201102.tar.xz || exit $?
