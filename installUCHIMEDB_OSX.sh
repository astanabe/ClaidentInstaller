...
mv dairydb1.1.2.fasta $PREFIX/share/claident/uchimedb/ || sudo mv dairydb1.1.2.fasta $PREFIX/share/claident/uchimedb/ || exit $?
...
gmd5sum -c SILVA_132_LSURef_tax_silva.fasta.gz.md5 || exit $?
...
gmd5sum -c SILVA_132_SSURef_tax_silva.fasta.gz.md5 || exit $?
...
gsha256sum -c cdu_20180529.tar.xz.sha256 || exit $?
rm cdu_20180529.tar.xz.sha256 || exit $?
gnutar -xJf cdu_20180529.tar.xz || exit $?
