...
mv SILVA_128_LSURef_tax_silva.fasta $PREFIX/share/claident/uchimedb/silva128LSUref.fasta || exit $?
mv SILVA_128_SSURef_tax_silva.fasta $PREFIX/share/claident/uchimedb/silva128SSUref.fasta || exit $?
