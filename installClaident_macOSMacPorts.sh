...
gnutar -xzf Claident-0.9.2021.10.15.tar.gz || exit $?
...
gnutar -xzf vsearch-2.18.0.tar.gz || exit $?
...
gnutar -xzf vsearch5d-2.18.0.tar.gz || exit $?
...
gnutar -xzf R-4.1.1.tar.gz || exit $?
cd R-4.1.1 || exit $?
