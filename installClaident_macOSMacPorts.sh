...
wget -nv -c https://github.com/astanabe/Claident/archive/v0.9.2022.04.11.tar.gz -O Claident-0.9.2022.04.11.tar.gz || exit $?
gnutar -xzf Claident-0.9.2022.04.11.tar.gz || exit $?
cd Claident-0.9.2022.04.11 || exit $?
...
cd .. || exit $?
rm -rf Claident-0.9.2022.04.11 || exit $?
rm -f Claident-0.9.2022.04.11.tar.gz || exit $?
touch .claident || exit $?
fi
