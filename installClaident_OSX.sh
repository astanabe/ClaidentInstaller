...
gnutar -xzf vsearch-2.0.0.tar.gz || exit $?
...
gnutar -xzf vsearch5d-2.0.0.tar.gz || exit $?
...
wget -c ftp://ftp.ncbi.nlm.nih.gov/blast/executables/blast+/2.4.0/ncbi-blast-2.4.0+-universal-macosx.tar.gz || exit $?
